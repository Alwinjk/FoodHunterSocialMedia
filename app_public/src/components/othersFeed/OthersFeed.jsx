...
import './othersFeed.css';

const OthersFeed = ({ user, currentUser }) => {
    ...
    console.log("current user in others feed", currentUser);
    useEffect(() => {
        fetchUserPosts();
    }, []);
...
export default connect(mapStateToProps)(OthersFeed);
